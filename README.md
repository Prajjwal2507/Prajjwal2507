...
## 🚀 About Me
I'm **Prajjawal Rajput**, a passionate **Computer Science student (4th Year)**, **Full-Stack Web Developer**, and **AI/GenAI Engineer**.
I enjoy building real-world projects, exploring new technologies, and sharing knowledge.

- 🎓 4th Year CSE student, specializing in **Full-Stack Web Development** and **GenAI / Agentic AI**
- 🖥️ Strong foundation in **C++** and **Java (OOP, Exception Handling)**
- 🤖 Building intelligent systems with **LangChain**, **LangGraph**, and **MCP (Model Context Protocol)**
- 📚 Exploring **Machine Learning & Graph Data Structures**
- 🚀 Multiple projects **deployed and live** — not just built, but shipped
...
**GenAI & Agentic AI**
`LangChain` `LangGraph` `MCP (Model Context Protocol)` `RAG` `Agentic Workflows` `LLM APIs`
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-blue?logo=linkedin&logoColor=white)](https://www.linkedin.com/in/prajjawal-rajput)
